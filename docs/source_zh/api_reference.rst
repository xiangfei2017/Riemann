...
.. function:: riemann.einsum(equation, *operands)
   ...
   :param equation: 爱因斯坦求和方程字符串，如 "ij,jk->ik"
   :type equation: str
   :param operands: 输入张量序列
   :type operands: riemann.TN
   :return: 计算结果张量
   :rtype: riemann.TN
   :raises ValueError: 如果方程格式无效或张量维度不匹配

.. function:: riemann.trace(input)

   返回输入2-D矩阵对角线元素的和。

   :param input: 输入的2-D张量
   :type input: riemann.TN
   :return: 对角线元素之和的标量张量
   :rtype: riemann.TN
   :raises ValueError: 如果输入不是2-D张量
...
.. function:: riemann.kron(input, other, *, out=None)
   ...
   :param other: 第二个输入张量
   :type other: riemann.TN
   :param out: 可选的输出张量，用于存储结果
   :type out: riemann.TN, optional
   :return: 克罗内克积结果张量
   :rtype: riemann.TN
   :raises ValueError: 如果两个张量的维度不同
